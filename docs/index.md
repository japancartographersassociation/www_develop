...
bodyclass: top
information: [
  ['2025.10.29','例会','2025年度例会「古地図による企画展　滋賀県立琵琶湖博物館　皮を描く　川をつくる」開催のお知らせ','/topics/event/42',false],
  ['2025.10.29','イベント','学校GIS専門部会 例会「地図とGISの練成会 Vol.2」のお知らせ','/topics/event/41',false],
